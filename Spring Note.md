...
<td>create a new one if none exists</td>
</tr>
<tr>
<td>REQUIRES_NEW</td>
<td><strong>always Create a new transaction</strong>, suspending the current transaction if one exists</td>
